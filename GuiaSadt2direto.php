...
$procedimento_tabela2= $_GET["procedimento_tabela2"];
$procedimento_codigo2= $_GET["procedimento_codigo2"];
$procedimento_nome2=$_GET["procedimento_nome2"];
...
<div class="procedimento" style="letter-spacing:6px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b><?php if($unicos == 0) {echo $procedimento_tabela2; }else {echo $procedimento_tabela6;}?></b><div> 
<div class="codigo_procedimento" style="letter-spacing:7px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b><?php if($unicos == 0) {echo $procedimento_codigo2;}else {echo $procedimento_codigo6;} ?></b><div>
<div class="descricao_procedimento" style="letter-spacing:0px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b><?php if($unicos==0){ echo $procedimento_nome2;}else { echo $procedimento_nome6;} ?></b><div>
 <!-- segunda fileira de procedimento --> 
<div class="procedimento2" style="letter-spacing:6px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b><?php if($unicos == 0) {}else{echo $procedimento_tabela7;} ?></b><div> 
<div class="codigo_procedimento2" style="letter-spacing:7px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b><?php if($unicos == 0){}else {echo $procedimento_codigo7;} ?></b><div>
<div class="descricao_procedimento2" style="letter-spacing:0px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b><?php if($unicos == 0){}else {echo $procedimento_nome7;} ?></b><div>
<!-- terceira fileira de procedimento --> 
<div class="procedimento3" style="letter-spacing:6px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b><?php if($unicos == 0){}else{ echo $procedimento_tabela8; }?> </b><div> 
<div class="codigo_procedimento3" style="letter-spacing:7px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b><?php if($unicos == 0){}else{ echo $procedimento_codigo8;} ?></b><div>
<div class="descricao_procedimento3" style="letter-spacing:0px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b><?php if($unicos == 0){}else{echo $procedimento_nome8;} ?></b><div>
<!-- quarta fileira de procedimento --> 
<div class="procedimento4" style="letter-spacing:6px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b><?php if($unicos == 0){}else{echo $procedimento_tabela9; }?></b><div> 
<div class="codigo_procedimento4" style="letter-spacing:7px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b><?php if($unicos == 0){}else{ echo $procedimento_codigo9;} ?></b><div>
<div class="descricao_procedimento4" style="letter-spacing:0px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b><?php if($unicos == 0){}else{ echo $procedimento_nome9;}?></b><div>
<!-- quinta fileira de procedimento --> 
<div class="procedimento5" style="letter-spacing:6px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b><?php if($unicos == 0){}else{ echo $procedimento_tabela10; } ?></b><div> 
<div class="codigo_procedimento5" style="letter-spacing:7px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b><?php if($unicos == 0){}else{ echo $procedimento_codigo10;} ?></b><div>
<div class="descricao_procedimento5" style="letter-spacing:0px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b><?php if($unicos == 0){}else{ echo $procedimento_nome10; } ?></b><div>
