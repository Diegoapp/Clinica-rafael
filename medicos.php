        ...
        <div class="navbar-inner">
            ...
            <div class="btn-group pull-right">
                ...
                <ul class="dropdown-menu">
                     <li><a href="atendentes.php">Atendentes</a></li>
                      <li class="divider"></li>
                    <li><a href="procedimento.php">Procedimentos</a></li>
                      <li class="divider"></li>
...
<div class=" row">
    ...
    <div class="col-md-3 col-sm-3 col-xs-6">
        <a data-toggle="tooltip" title="Novo CBO" class="well top-block" href="cbo.php">
    ...
    <div class="col-md-3 col-sm-3 col-xs-6">
        <a data-toggle="tooltip" title="Novo Convênio" class="well top-block" href="convenios.php">
            <i class="glyphicon glyphicon-edit icon-white"></i>

            <div>Convênios</div>
            <div><?php echo $numeroconvenios; ?></div>
...
<div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Médicos</h2>
...
$sqlconvenios ="SELECT * FROM medicos";


$consulta = $conn->query($sqlconvenios);
...
echo '<td class="center"> '.$registro["id_medico"].'</td>';

echo '<td class="center"> '.$registro["nome_medico"].'</td>';

echo '<td class="center"> '.$registro["crm_medico"].' </td>';

echo ' <td class="center">';
echo ' <span class="center">'.$registro["uf_crm_medico"].'</span>';
echo ' </td>';
echo ' <td class="center">';
echo ' <a class="btn btn-info" onclick="funcaoview('.$registro["id_medico"].')" href="#">';
echo ' <i class="glyphicon glyphicon-zoom-in icon-white"></i>';
echo ' View'; 
echo ' </a>'; 
echo ' <a class="btn btn-info" onclick="funcaoedita('.$registro["id_medico"].')" href="#">';
echo ' <i class="glyphicon glyphicon-edit icon-white"></i>';
echo ' Edit'; 
echo ' </a>';
echo ' <a class="btn btn-info" onclick="funcaodeleta('.$registro["id_medico"].')" href="#">';
...
function funcaoview(get) {
  ...
  window.open('viewmedico.php?id='+get+'', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=650, HEIGHT=400'
  ); 
}

function funcaoedita(get) {
	
	 window.open('editamedico.php?id='+get+'', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=650, HEIGHT=400'
  ); 
...
function funcaodeleta(get) {
	 ...
	 window.open('deletamedico.php?id='+get+'', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=650, HEIGHT=400'
  ); 
	...
	function funcaonova() {
	 ...
	 window.location.assign("novomedico.php");
