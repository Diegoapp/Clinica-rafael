...
$nome  = $_POST['nome'];
$convenio = utf8_encode($_POST['convenio']);

$query = "UPDATE clientes SET nome = '".utf8_encode($nome)."', convenio = '".utf8_encode($convenio)."' WHERE (id = ".$id.")";
