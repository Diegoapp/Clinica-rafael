...
function funcaodeleta(get,id) {
	 ...
	 window.open('http://localhost/Clinica/myprojeto/geraguia.php?id_cliente='+get+'', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=650, HEIGHT=400'
  ); 
	...
	function vai() {
	 ...
	 window.location.assign("http://localhost/Clinica/myprojeto/iniciosec.php");
	
	}
	
	function funcaoatendimento(get) {
	
	 window.open('http://localhost/Clinica/myprojeto/atendimento.php?id='+get+'', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=350, HEIGHT=200'
  ); 
