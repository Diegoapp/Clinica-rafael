...
$statement = $conn->prepare('INSERT INTO medicos(crm_medico, nome_medico, conselho_medico, uf_crm_medico, cbo_medico, senha_medico) VALUES (:crm_medico, :nome_medico, :conselho_medico, :uf_crm_medico, :cbo, :senha_medico)');
...
$statement->bindParam(':crm_medico',     $crm);
$statement->bindParam(':nome_medico', $nome);
$statement->bindParam(':conselho_medico', $conselho);
$statement->bindParam(':uf_crm_medico', $crm_estado);
$statement->bindParam(':cbo', $cbo);
$statement->bindParam(':senha_medico', $senha);


// Executa a sentença já com os valores
if($statement->execute()){
  // Definimos a mensagem de sucesso
  echo '<script>alert("Parabens! Médico Cadastrado com sucesso!"); </script>'; 
  ...
  <div class="row">
    ...
    <ul class="breadcrumb">
        ...
        <li>
         ...
         <li>
            <a href="novomedico.php">Novo medicos</a>
        </li>
    </ul>
</div>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i>     Cadastro de Médicos </h2>
     ...
     <form role="form"  action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="crm" name="crm" class="form-control" id="exampleInputEmail1" placeholder="CRM">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Senha:</label>
                        <input type="Senha" name="senha" class="form-control" id="exampleInputEmail1" placeholder="Senha">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Conselho:</label>
                        <input type="conselho" name="conselho" class="form-control" id="exampleInputEmail1" placeholder="Conselhor do Médico">
                    </div>
                ...
                <div class="control-group">
                    <label class="control-label" for="selectError">UF CRM</label>
                    <div class="controls">
                        
                        
                   <select id="selectError" name="crm_estado" data-rel="chosen">
...
echo '<label class="control-label" for="selectError">CBO</label>';
echo '<div class="controls">'; 
echo ' <select id="selectError" name="cbo" data-rel="chosen">';
...
// Seleciona o Banco de dados através da conexão acima
                 ...
                 $resultado = $conn->query($sql);
				   ...
				   echo '<option name = cbo value='.$row["num_cbo"].'>'.utf8_encode($row["nome_cbo"]).'</option>';
