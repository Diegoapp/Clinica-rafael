...
$statement = $pdo->prepare('INSERT INTO secretaria (nome_secretaria, senha_secretaria) VALUES (:nome_secretaria, :senha_secretaria)');
...
$statement->bindParam(':nome_secretaria', $nome);
$statement->bindParam(':senha_secretaria', $senha);
...
if($statement->execute()){
  ...
  echo '<script>alert("Parabens! Atendente Cadastrado com sucesso!"); </script>'; 
  ...
  <div class="row">
    ...
    <ul class="breadcrumb">
        ...
        <li>
         ...
         <li>
            <a href="novoatendente.php">Novo Atendente</a>
        </li>
    </ul>
</div>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i>     Cadastro de Atendentes </h2>
     ...
     <form role="form"  action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="num" name="senha" class="form-control" id="exampleInputEmail1" placeholder="Senha">
                    </div>
