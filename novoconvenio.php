...
try{
  ...
  $destino = 'img_convenios/' . $_FILES['arquivo']['name'];
  ...
  <div class="row">
    ...
    <ul class="breadcrumb">
        ...
        <li>
         ...
         <li>
            <a href="novoconvenio.php">Novo Convenio</a>
        </li>
    </ul>
</div>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i>     Cadastro de Convenio </h2>
     ...
     <form role="form"  action="uploud.php" method="post"  enctype="multipart/form-data" >
