...
$statement = $pdo->prepare('INSERT INTO procedimento(tabel_procedimento, codigo_procedimento, descricao_procedimento, atalho) VALUES (:tabel, :codigo, :descricao, :atalho)');



// Adiciona os dados acima para serem executados na sentença
$statement->bindParam(':tabel', $tabela);
$statement->bindParam(':codigo', $codigo);
$statement->bindParam(':descricao', $descricao);
$statement->bindParam(':atalho', $atalho);

// Executa a sentença já com os valores
if($statement->execute()){
  // Definimos a mensagem de sucesso
  echo '<script>alert("Parabens! Procedimento Cadastrado com sucesso!"); </script>'; 
  ...
  <div class="row">
    ...
    <ul class="breadcrumb">
        ...
        <li>
         ...
         <li>
            <a href="novoprocedimento.php">Novo Procedimento</a>
        </li>
    </ul>
</div>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i>     Cadastro de Procedimento </h2>
     ...
     <form role="form"  action="" method="post">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Tabela:</label>
                        <input type="nome" name="tabela" class="form-control" id="exampleInputEmail1" placeholder="Tabela">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">codigo:</label>
                        <input type="num" name="codigo" class="form-control" id="exampleInputEmail1" placeholder="Código">
                    </div>
                   <div class="form-group">
                        <label for="exampleInputEmail1">Descrição:</label>
                        <input type="num" name="descricao" class="form-control" id="exampleInputEmail1" placeholder="Descrição">
                    </div>
	
    <div class="form-group">
                        <label for="exampleInputEmail1">Atalho:</label>
                        <input type="num" name="atalho" class="form-control" id="exampleInputEmail1" placeholder="Atalho">
                    </div>
                        </select>
                    </div>
                </div>
