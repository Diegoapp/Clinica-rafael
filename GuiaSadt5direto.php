...
<div class="procedimento" style="letter-spacing:6px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b><?php  echo $procedimento_tabela5; ?></b><div> 
<div class="codigo_procedimento" style="letter-spacing:7px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b><?php echo $procedimento_codigo5; ?></b><div>
<div class="descricao_procedimento" style="letter-spacing:0px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b><?php echo $procedimento_nome5;?></b><div>
