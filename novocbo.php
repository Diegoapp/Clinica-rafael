...
$statement = $pdo->prepare('INSERT INTO cbo (nome_cbo, num_cbo) VALUES (:nome_cbo, :num_cbo)');
...
$statement->bindParam(':nome_cbo',     $nome);
$statement->bindParam(':num_cbo', $num);
...
if($statement->execute()){
  ...
  echo '<script>alert("Parabens! CBO Cadastrado com sucesso!"); </script>'; 
...
<div class="ch-container">
  <div class="row">
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <a href="inicio.php">Sistema</a>
        </li>
         <li>
            <a href="novocbo.php">Novo CBO</a>
        </li>
    </ul>
</div>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i>     Cadastro de CBO </h2>
     ...
     <form role="form"  action="" method="post">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Numeração:</label>
                        <input type="num" name="num" class="form-control" id="exampleInputEmail1" placeholder="numeração">
                    </div>
