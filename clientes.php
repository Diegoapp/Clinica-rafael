...
$sqlconvenios ="SELECT clientes.convenio, clientes.id, clientes.nome, convenios.id_convenios, convenios.nome_convenio FROM clientes INNER JOIN convenios on clientes.convenio = convenios.id_convenios WHERE clientes.nome LIKE '%$nomecliente%'";
...
echo '<td class="center"> '.utf8_encode($registro["nome"]).'</td>';
                ...
                <div class="modal-body">
                 ...
                 <script> 
                   function buscaclientes() { 
					...
					window.location.replace('clientes.php?clientes='+nome+'');
                   }
