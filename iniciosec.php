...
<body>
    ...
    <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-inner">
            ...
            <a class="navbar-brand" href="#"><!-- <img alt="Sistema Clinica " src="" class="hidden-xs"/> -->
                <span>Clinica</span></a>
...
<td>
                            <a href="#" class="btn btn-info btn-setting">Buscar Clientes</a>
                        </td></div>
...
$sqlconvenios ="SELECT clientes.convenio, clientes.id, clientes.nome, convenios.id_convenios, convenios.nome_convenio, clientes.atendimento FROM clientes INNER JOIN convenios on clientes.convenio = convenios.id_convenios WHERE clientes.nome LIKE '%$nomecliente%'";
...
if( $registro["atendimento"] == $atendimentoo){
...
function funcaodeleta(get) {
	 ...
	 window.open('/DELETACLIENTE.php?id='+get+'', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=650, HEIGHT=400'
  ); 
	...
	function funcaonova() {
	 ...
	 window.location.assign("/novocliente.php");
	...
	function funcaoatendimento(get) {
	  ...
	  window.location.assign('/atendimento.php?id='+get+'', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=350, HEIGHT=200'
  ); 
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                 ...
                 <script> 
                   function buscaclientes() { 
					...
					var nome = document.getElementById('Valor').value;
					
					window.location.replace('/iniciosec.php?clientes='+nome+'');
                   }
                ...
                <div class="modal-footer">
                    ...
                    <a href="#" class="btn btn-primary" onClick="buscaclientes()" data-dismiss="modal">Buscar</a>
                </div>
                 </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="#" class="btn btn-primary" data-dismiss="modal">Salve</a>
                </div>
            </div>
        </div>
    </div>
