...
<div class="procedimento" style="letter-spacing:6px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b><?php  echo $procedimento_tabela10; ?></b><div> 
<div class="codigo_procedimento" style="letter-spacing:7px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b><?php echo $procedimento_codigo10; ?></b><div>
<div class="descricao_procedimento" style="letter-spacing:0px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b><?php echo $procedimento_nome10; ?></b><div>
 <!-- segunda fileira de procedimento --> 
<div class="procedimento2" style="letter-spacing:6px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b></b><div> 
<div class="codigo_procedimento2" style="letter-spacing:7px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b></b><div>
<div class="descricao_procedimento2" style="letter-spacing:0px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b></b><div>
<!-- terceira fileira de procedimento --> 
<div class="procedimento3" style="letter-spacing:6px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b> </b><div> 
<div class="codigo_procedimento3" style="letter-spacing:7px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b></b><div>
<div class="descricao_procedimento3" style="letter-spacing:0px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b></b><div>
<!-- quarta fileira de procedimento --> 
<div class="procedimento4" style="letter-spacing:6px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b></b><div> 
<div class="codigo_procedimento4" style="letter-spacing:7px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b></b><div>
<div class="descricao_procedimento4" style="letter-spacing:0px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b></b><div>
<!-- quinta fileira de procedimento --> 
<div class="procedimento5" style="letter-spacing:6px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b></b><div> 
<div class="codigo_procedimento5" style="letter-spacing:7px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b></b><div>
<div class="descricao_procedimento5" style="letter-spacing:0px; font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#333;"><b></b><div>
...
if ($unicos == 0){
	...
	if($unicos == 1){
			if($multiplo > 15){
			    echo '<script> window.print(); </script>';
				echo '<script> setTimeout("msg(); ",2000);</script>';
				}else{
				echo '<script> window.print(); </script>';
	           	echo '<script> setTimeout("window.close(); ",100); </script>';
