...
<div class=" row">
    ...
    <div class="col-md-3 col-sm-3 col-xs-6">
        <a data-toggle="tooltip" title="Verificação de Finanças" class="well top-block" href="cbo.php">
...
<div class="row">
 ...
 <i class="glyphicon glyphicon-edit icon-white"></i>
 Novo Atendente
</a> <a href="atendentes.php" target="_blank"></a></div>
...
$sqlconvenios ="SELECT * FROM secretaria";
...
echo '<td class="center"> '.$registro["id_secretaria"].'</td>';

echo '<td class="center"> '.$registro["nome_secretaria"].'</td>';
echo '<td class="center"> '.$registro["senha_secretaria"].'</td>';

echo ' <td class="center">';


echo ' <a class="btn btn-info" onclick="funcaodeleta('.$registro["id_secretaria"].')" href="#">';
...
function funcaodeleta(get) {
	 ...
	 window.open('/deletaatendente.php?id='+get+'', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=650, HEIGHT=400'
  ); 
	...
	function funcaonova() {
	 ...
	 window.location.assign("/novoatendente.php");
