...
<div class="ch-container">
  <div class="row">
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <a href="convenios.php">Convênio</a>
        </li>
    </ul>
</div>
<div class=" row">
...
<div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i>Convenios </h2>
...
$sqlconvenios = "SELECT * FROM convenios";
...
echo '<td class="center"> '.$registro["id_convenios"].'</td>';

echo '<td class="center"> '.utf8_encode($registro["nome_convenio"]).'</td>';

echo '<td class="center">'.$registro["logo_convenio"].'</td>';
...
/*echo ' <a class="btn btn-info" onclick="funcaoedita('.$registro["id_convenios"].')" href="#">';
echo ' <i class="glyphicon glyphicon-edit icon-white"></i>';
echo ' Edit'; 
echo ' </a>'; */
echo ' <a class="btn btn-info" onclick="funcaodeleta('.$registro["id_convenios"].')" href="#">';
...
function funcaodeleta(get) {
	 ...
	 window.open('/deletaconvenio.php?id='+get+'', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=650, HEIGHT=400'
  ); 
	...
	function funcaonova() {
	 ...
	 window.location.assign("/novoconvenio.php");
