...
<div class=" row">
    ...
    <div class="col-md-3 col-sm-3 col-xs-6">
        <a data-toggle="tooltip" title="Novo Convenio" class="well top-block" href="#">
            <i class="glyphicon glyphicon-edit icon-white"></i>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> Configurações! </h2>
...
$query = "UPDATE configuracoes SET nome = '".$nome."', ans = '".$ans."'";
...
if($atualiza){ 
 ...
 echo '<script>alert("0.0! Erro ao auterar  "). mysql_error(); </script>'; 
  echo '<script> window.close(); </script>';	
          ...
          //  $consulta = mysql_query($sql);
			...
			while( $registro = $consulta->fetch()){
      		echo '<div class="form-group has-success col-md-4">';
			
			echo '<label class="control-label" for="inputSuccess1">Nome Fantasia:</label>';
			echo '<input  name="nome" value="'.utf8_encode($registro['nome']).'" type="text" class="form-control" id="inputSuccess1">';
			echo '</div> ';
			
			echo '<div class="form-group has-success col-md-4">';
			
			echo '<label class="control-label" for="inputSuccess1">ANS:</label>';
			echo ' <input name="ans" type="text" value="'.$registro["ans"].'" class="form-control" id="inputSuccess1">';
			echo '</div>';
          ...
          <center>  <input type="hidden" name="acao" value="enviado"> 
            <button type="submit" value="acao" class="btn btn-default">Editar</button> </center>
           </form>  
