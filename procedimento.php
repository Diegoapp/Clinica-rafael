...
<div class="ch-container">
  <div class="row">
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <a href="Procedimento.php">Procedimento</a>
        </li>
    </ul>
</div>
<div class=" row">
   ...
   <div class="col-md-3 col-sm-3 col-xs-6">
        <a data-toggle="tooltip" title="Novo Convenio" class="well top-block" href="convenios.php">
            <i class="glyphicon glyphicon-edit icon-white"></i>
...
<div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Procedimento </h2>
...
$sqlconvenios = "SELECT * FROM procedimento";
...
echo '<td class="center"> '.$registro["id_procedimento"].'</td>';

echo '<td class="center"> '.utf8_encode($registro["descricao_procedimento"]).'</td>';
...
//echo ' <a class="btn btn-info" onclick="funcaoedita('.$registro["id_procedimento"].')" href="#">';
//echo ' <i class="glyphicon glyphicon-edit icon-white"></i>';
//echo ' Edit'; 
//echo ' </a>';
echo ' <a class="btn btn-info" onclick="funcaodeleta('.$registro["id_procedimento"].')" href="#">';
...
function funcaoview(get) {
  ...
  window.open('/viewcbo.php?id='+get+'', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=650, HEIGHT=400'
  ); 
}

function funcaoedita(get) {
	
	 window.open('/editcbo.php?id='+get+'', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=650, HEIGHT=400'
  ); 
...
function funcaodeleta(get) {
	 ...
	 window.open('/deletaprocedimento.php?id='+get+'', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=650, HEIGHT=400'
  ); 
	...
	function funcaonova() {
	 ...
	 window.location.assign("/novoprocedimento.php");
